...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SegmentOwner) DeepCopyInto(out *SegmentOwner) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SegmentOwner.
func (in *SegmentOwner) DeepCopy() *SegmentOwner {
	if in == nil {
		return nil
	}
	out := new(SegmentOwner)
	in.DeepCopyInto(out)
	return out
}
