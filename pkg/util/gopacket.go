// Copied from nttcom/fluvia MIT license
// https://github.com/nttcom/fluvia/blob/main/pkg/bpf/srv6.go#L12
package util
...
func LogPacket(file string, pkt []byte) error {
	f, err := os.Create("/tmp/output.pcapng")
	if err != nil {
		return err
	}
	defer f.Close()
