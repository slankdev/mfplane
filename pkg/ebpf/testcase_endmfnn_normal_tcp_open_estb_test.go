...
type EndMfnNormalTcpOpenEstbTestCase struct{}

func (tc EndMfnNormalTcpOpenEstbTestCase) GenerateInput() ([]byte, error) {
	// Ethernet
...
func (tc EndMfnNormalTcpOpenEstbTestCase) GenerateOutput() (int, []byte, error) {
	// Ethernet
	ethernetLayer := &layers.Ethernet{
...
func (tc EndMfnNormalTcpOpenEstbTestCase) OutputPostProcess(b []byte) ([]byte, error) {
	return b, nil
}

func (tc EndMfnNormalTcpOpenEstbTestCase) PreTestMapContext() *MapContext {
	c := MapContext{
		Fib6: Fib6Render{
...
func (tc EndMfnNormalTcpOpenEstbTestCase) PostTestMapContextPreprocess(mc *MapContext) {
	mc.Fib6 = Fib6Render{}
...
func (tc EndMfnNormalTcpOpenEstbTestCase) PostTestMapContextExpect() *MapContext {
	c := MapContext{
		Fib6: Fib6Render{},
		NatOut: NatOutRender{
			Items: []NatOutRenderItem{
...
func TestEndMfnNormalTcpOpenEstbTestCase(t *testing.T) {
	ExecuteTestCase(EndMfnNormalTcpOpenEstbTestCase{}, t)
}
