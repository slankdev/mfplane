...
func (tc EndMfnNormalTcpCloseFinTestCase) PreTestMapContext() *MapContext {
	c := MapContext{
		Fib6: Fib6Render{
...
func (tc EndMfnNormalTcpCloseFinTestCase) PostTestMapContextPreprocess(mc *MapContext) {
	mc.Fib6 = Fib6Render{}
...
func (tc EndMfnNormalTcpCloseFinTestCase) PostTestMapContextExpect() *MapContext {
	c := MapContext{
		Fib6: Fib6Render{},
		NatOut: NatOutRender{
			Items: []NatOutRenderItem{
