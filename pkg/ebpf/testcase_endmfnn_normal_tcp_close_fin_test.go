...
type EndMfnNormalTcpCloseFinTestCase struct{}

func (tc EndMfnNormalTcpCloseFinTestCase) ProgInfo() (string, []string) {
...
func (tc EndMfnNormalTcpCloseFinTestCase) GenerateInput() ([]byte, error) {
	// Ethernet
...
func (tc EndMfnNormalTcpCloseFinTestCase) GenerateOutput() (int, []byte, error) {
	// Ethernet
	ethernetLayer := &layers.Ethernet{
...
func (tc EndMfnNormalTcpCloseFinTestCase) OutputPostProcess(b []byte) ([]byte, error) {
	return b, nil
}

func (tc EndMfnNormalTcpCloseFinTestCase) PreTestMapContext() *ProgRunMapContext {
	c := ProgRunMapContext{
...
func (tc EndMfnNormalTcpCloseFinTestCase) PostTestMapContextPreprocess(mc *ProgRunMapContext) {
...
func (tc EndMfnNormalTcpCloseFinTestCase) PostTestMapContextExpect() *ProgRunMapContext {
	c := ProgRunMapContext{
		NatOutRender: NatOutRender{
			Items: []NatOutRenderItem{
				{
...
func TestEndMfnNormalTcpCloseFinTestCase(t *testing.T) {
	ExecuteTestCase(EndMfnNormalTcpCloseFinTestCase{}, t)
}
